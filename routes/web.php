...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::group(['prefix' => 'gio-hang', 'middleware' => 'CheckActiveUser'], function (){
    ...
    Route::group(['prefix' => 'xac-minh-email'], function (){
        Route::get('/{id}', 'RegisterController@active')->name('active_user');
        Route::get('/', 'RegisterController@active');
    });
    Route::group(['prefix' => 'kich-hoat'], function (){
        Route::get('/', 'RegisterController@verification');
        Route::post('/', 'RegisterController@changeActive');
    });

    Route::group(['prefix' => 'quen-mat-khau', 'middleware' => 'CheckUserLogin'], function (){
        Route::get('/', 'ForgotPasswordController@showForgetPasswordForm');
        Route::post('/', 'ForgotPasswordController@submitForgetPasswordForm');
    });

    Route::group(['prefix' => 'dat-lai-mat-khau', 'middleware' => 'CheckUserLogin'], function (){
        Route::get('/{token}', 'ForgotPasswordController@showResetPasswordForm')->name('reset.password.get');
        Route::post('/', 'ForgotPasswordController@submitResetPasswordForm');
    });

    Route::group(['prefix' => 'tai-khoan', 'middleware' => ['CheckUserLogout', 'CheckActiveUser']], function (){
        Route::get('/', function (){
...
Route::group(['namespace' => 'Shop', 'middleware' => 'CheckUserLogout'], function (){
   Route::group(['prefix' => 'shop'], function (){
        Route::get('/', 'ShopController@getShop')->middleware('CheckShop');
        Route::group(['prefix' => 'product'], function (){
            Route::get('/', 'ShopController@getProduct')->middleware('CheckShop');
            Route::get('add', 'ShopController@getAddProduct');
            Route::post('add', 'ShopController@postAddProduct');
            Route::get('edit/{product_id}', 'ShopController@getEditProduct');
            Route::post('edit/{product_id}', 'ShopController@postEditProduct');
            Route::get('delete/{product_id}', 'ShopController@getDelProduct');
        });

        Route::group(['prefix' => 'order'], function (){
           Route::get('/', 'ShopController@getOrder');
            Route::get('edit/{order_id}', 'ShopController@getEditOrder');
            Route::post('edit/{order_id}', 'ShopController@postEditOrder');
            Route::get('delete/{order_id}', 'ShopController@getDelOrder');
        });


        Route::get('/dang-ky', 'ShopController@showRegister');
        Route::post('/dang-ky', 'ShopController@register');
   }) ;
});
...
Route::group(['namespace' => 'Admincp'], function (){
    Route::group(['prefix' => 'admincp'], function (){
        Route::get('/', function (){
            return redirect()->intended('admincp/dashboard/category');
        });
        ...
        Route::group(['prefix' => 'dashboard', 'middleware' => ['CheckLogedOut', 'CheckLevel']], function (){
            ...
            Route::group(['prefix' => 'manage-user'], function (){
                ...
                Route::group(['prefix' => 'shop'], function (){
                    Route::get('/', 'UserController@getShop');
                    Route::get('/accept/{id}', 'UserController@acceptShop');
                    Route::get('/cancel/{id}', 'UserController@cancelShop');
                });
